...
\begin{rem}
$\Z_n$ is a ring with operation $\overbar{a} \overset{+}{\underset{-}{\cdot}} \overbar{b} \coloneq \overline{a\overset{+}{\underset{-}{\cdot}}b}$ (well defined due in item~3 of~\cref{four})
...
\begin{proof}
  \begin{align*}
    \sum_{d\divides n} \mu(d) S_f\left(\frac{n}{d}\right)
      ...
      &= \sum_{e\divides n} f(e) \underbrace{\sum_{d\divides  \frac{n}{e} \mu(d)} {=
		\begin{cases}
		  1 & \frac{n}{e} = 1 \\
		  0 & \text{otherwise}
		\end{cases}}}_%
		{\text{Using }
		    ...
		    \Leftrightarrow e\divides n \land d\divides \frac{n}{e} = f(n)}
  \end{align*}
\end{proof}
